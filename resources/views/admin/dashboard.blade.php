    ...
    <div class="top-bar">
                ...
                <div class="search-result__content">
                    ...
                    <div class="mb-5">
                        <a href="" class="flex items-center mt-2">
                            <div class="w-8 h-8 image-fit">
                                <img alt="Midone - HTML Admin Template" class="rounded-full"
                                    src="http://rubick.left4code.com/dist/images/profile-12.jpg">
                            </div>
                        ...
                        <a href="" class="flex items-center mt-2">
                            <div class="w-8 h-8 image-fit">
                                <img alt="Midone - HTML Admin Template" class="rounded-full"
                                    src="http://rubick.left4code.com/dist/images/profile-5.jpg">
                            </div>
                        ...
                        <a href="" class="flex items-center mt-2">
                            <div class="w-8 h-8 image-fit">
                                <img alt="Midone - HTML Admin Template" class="rounded-full"
                                    src="http://rubick.left4code.com/dist/images/profile-7.jpg">
                            </div>
                    ...
                    <a href="" class="flex items-center mt-2">
                        <div class="w-8 h-8 image-fit">
                            <img alt="Midone - HTML Admin Template" class="rounded-full"
                                src="http://rubick.left4code.com/dist/images/preview-1.jpg">
                        </div>
                    ...
                    <a href="" class="flex items-center mt-2">
                        <div class="w-8 h-8 image-fit">
                            <img alt="Midone - HTML Admin Template" class="rounded-full"
                                src="http://rubick.left4code.com/dist/images/preview-13.jpg">
                        </div>
                    ...
                    <a href="" class="flex items-center mt-2">
                        <div class="w-8 h-8 image-fit">
                            <img alt="Midone - HTML Admin Template" class="rounded-full"
                                src="http://rubick.left4code.com/dist/images/preview-12.jpg">
                        </div>
                        <div class="ml-3">Nike Tanjun</div>
                        <div class="ml-auto w-48 truncate text-slate-500 text-xs text-right">Sport &amp; Outdoor
                        </div>
        ...
        <div class="intro-x dropdown w-8 h-8">
            <div class="dropdown-toggle w-8 h-8 rounded-full overflow-hidden shadow-lg image-fit zoom-in" role="button"
                aria-expanded="false" data-tw-toggle="dropdown">
                <img alt="Midone - HTML Admin Template" src="http://rubick.left4code.com/dist/images/profile-1.jpg">
            </div>
                    ...
                    <div class="mt-5">
                        <div class="intro-y">
                            <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                ...
                                <div class="ml-4 mr-auto">
                                    ...
                                    <div class="text-slate-500 text-xs mt-0.5">12 August 2020</div>
                                </div>
                                <div
                        ...
                        <div class="intro-y">
                            <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                ...
                                <div class="ml-4 mr-auto">
                                    ...
                                    <div class="text-slate-500 text-xs mt-0.5">5 June 2022</div>
                                </div>
                                <div
                                    class="py-1 px-2 rounded-full text-xs bg-success text-white cursor-pointer font-medium">
                                    137 Sales</div>
                        ...
                        <div class="intro-y">
                            <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                    <img alt="Midone - HTML Admin Template"
                                        src="http://rubick.left4code.com/dist/images/profile-3.jpg">
                                </div>
                                <div class="ml-4 mr-auto">
                                        ...
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                    ...
                                                    title="Uploaded at 12 August 2020">
                                            </div>
                                            ...
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                    src="http://rubick.left4code.com/dist/images/preview-11.jpg"
                                                    title="Uploaded at 20 December 2021">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr class="intro-x">
                                    <td class="w-40">
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                    src="http://rubick.left4code.com/dist/images/preview-6.jpg"
                                                    title="Uploaded at 14 June 2022">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                    src="http://rubick.left4code.com/dist/images/preview-1.jpg"
                                                    title="Uploaded at 30 August 2020">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                    src="http://rubick.left4code.com/dist/images/preview-2.jpg"
                                                    title="Uploaded at 7 August 2021">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr class="intro-x">
                                    <td class="w-40">
                                        <div class="flex">
                                            ...
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                    src="http://rubick.left4code.com/dist/images/preview-8.jpg"
                                                    title="Uploaded at 12 January 2021">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <a href="" class="font-medium whitespace-nowrap">Sony Master Series
                                            A9G</a>
                                        <div class="text-slate-500 text-xs whitespace-nowrap mt-0.5">Electronic
                                        </div>
                                    </td>
                                    ...
                                    <td class="w-40">
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                    src="http://rubick.left4code.com/dist/images/preview-6.jpg"
                                                    title="Uploaded at 20 November 2020">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                    src="http://rubick.left4code.com/dist/images/preview-10.jpg"
                                                    title="Uploaded at 22 June 2020">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                    src="http://rubick.left4code.com/dist/images/preview-10.jpg"
                                                    title="Uploaded at 26 May 2021">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                            ...
                            <div class="intro-x">
                                <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                    ...
                                    <div class="ml-4 mr-auto">
                                        ...
                                        <div class="text-slate-500 text-xs mt-0.5">16 December 2020</div>
                                    </div>
                        ...
                        <div
                            ...
                            <div class="intro-x relative flex items-center mb-3">
                                <div
                                    ...
                                    <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                        <img alt="Midone - HTML Admin Template"
                                            src="http://rubick.left4code.com/dist/images/profile-13.jpg">
                                    </div>
                                </div>
                            ...
                            <div class="intro-x relative flex items-center mb-3">
                                <div
                                    ...
                                    <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                        <img alt="Midone - HTML Admin Template"
                                            src="http://rubick.left4code.com/dist/images/profile-9.jpg">
                                    </div>
                                </div>
                                <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                    <div class="flex items-center">
