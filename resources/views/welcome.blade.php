...
<main class="main">
    <div class="page-content">
        <section class="intro-section">
            <div class="owl-carousel owl-theme row owl-dot-inner owl-dot-white intro-slider animation-slider cols-1 gutter-no"
                ...
                <div class="banner banner-fixed intro-slide1" style="background-color: #46b2e8;">
                    <figure>
                        <img src="{{ asset('user/images/demos/demo1/slides/slide1.jpg') }}" alt="intro-banner"
                        ...
                        <div class="banner-content y-50">
                            <h4 class="banner-subtitle font-weight-bold ls-l">
                                <span class="d-inline-block slide-animate"
                                    ...
                                    2 Get</span>
                                <span class="bg-white d-inline-block label-star text-primary slide-animate"
                                    data-animation-options="{'name': 'fadeInRightShorter', 'duration': '1s', 'delay': '.4s'}">1
                                    Free</span>
                            </h4>
                            <h2 class="text-white banner-title font-weight-bold lh-1 ls-md slide-animate"
                                data-animation-options="{'name': 'fadeInUpShorter', 'duration': '1.2s', 'delay': '1s'}">
                                Fashionable</h2>
                            <h3 class="text-white font-weight-normal lh-1 ls-l slide-animate"
                                data-animation-options="{'name': 'fadeInUpShorter', 'duration': '1.2s', 'delay': '1s'}">
                                Collection</h3>
                            <p class="text-white slide-animate ls-s mb-7"
                                data-animation-options="{'name': 'fadeInUpShorter', 'duration': '1.2s', 'delay': '1s'}">
                ...
                <div class="banner banner-fixed intro-slide2" style="background-color: #dddee0;">
                    <figure>
                        <img src="{{ asset('user/images/demos/demo1/slides/slide2.jpg') }}" alt="intro-banner"
                            width="1903" height="630" style="background-color: #d8d9d9;" />
                    </figure>
                    <div class="container">
                        <div class="ml-auto text-right banner-content y-50">
                            <h4 class="mb-1 banner-subtitle ls-s slide-animate"
                                data-animation-options="{'name': 'fadeInUp', 'duration': '.7s'}"><span
                                    class="mb-2 d-block text-uppercase">Coming soon</span><strong
                                    class="font-weight-semi-bold ls-m">Riode Birthday</strong></h4>
                            <h2 class="mb-2 banner-title d-inline-block font-weight-bold text-primary slide-animate"
                                data-animation-options="{'name': 'fadeInRight', 'duration': '1.2s', 'delay': '.5s'}">
                                Sale</h2>
                            <p class="mb-4 slide-animate font-primary ls-s text-dark"
                ...
                <div class="banner banner-fixed video-banner intro-slide3" style="background-color: #dddee0;">
                    <figure>
                        <video src="{{ asset('user/video/memory-of-a-woman.mp4') }}" width="1903" height="630"></video>
                    </figure>
                    <div class="container">
                        <div class="text-center banner-content x-50 y-50">
                            <h4 class="mb-3 text-white banner-subtitle text-uppercase ls-normal slide-animate"
                                data-animation-options="{'name': 'fadeIn', 'duration': '.7s'}">Check out our
                            </h4>
                            <h2 class="mb-3 text-white banner-title font-weight-bold text-uppercase ls-m slide-animate"
                                data-animation-options="{'name': 'fadeInUp', 'duration': '.7s', 'delay': '.5s'}">
                                Summer Season's</h2>
                            <p class="text-white slide-animate mb-7 ls-s font-primary "
                                ...
                                $199.00</p>
                            <a href="shop.html" class="mb-1 btn btn-dark btn-rounded slide-animate"
        ...
        <section class="pt-10 mt-7 appear-animate" data-animation-options="{
            ...
            <div class="container">
                <h2 class="mb-5 title title-center">Our Categories</h2>
                <div class="row">
                    <div class="mb-4 col-xs-6 col-lg-3">
                        <div class="category category-default1 category-absolute banner-radius overlay-zoom">
                            <a href="shop.html">
                                <figure class="category-media">
                                    <img src="{{ asset('user/images/categories/category1.jpg') }}" alt="category"
                    ...
                    <div class="mb-4 col-xs-6 col-lg-3">
                        <div class="category category-default1 category-absolute banner-radius overlay-zoom">
                            <a href="shop.html">
                                <figure class="category-media">
                                    <img src="{{ asset('user/images/categories/category2.jpg') }}" alt="category"
                                        width="280" height="280" style="background-color: #bcbdb7;" />
                                </figure>
                            </a>
                            <div class="category-content">
                    ...
                    <div class="mb-4 col-xs-6 col-lg-3">
                        <div class="category category-default1 category-absolute banner-radius overlay-zoom">
                            <a href="shop.html">
                                <figure class="category-media">
                                    <img src="{{ asset('user/images/categories/category3.jpg') }}" alt="category"
                                        width="280" height="280" style="background-color: #ececef;" />
                                </figure>
                            </a>
                            <div class="category-content">
                    ...
                    <div class="mb-4 col-xs-6 col-lg-3">
                        <div class="category category-default1 category-absolute banner-radius overlay-zoom">
                            <a href="shop.html">
                                <figure class="category-media">
                                    <img src="{{ asset('user/images/categories/category4.jpg') }}" alt="category"
                                        width="280" height="280" style="background-color: #e8eded;" />
                                </figure>
                            </a>
        ...
        <section class="container pt-4 pb-8 mt-6 product-wrapper appear-animate mt-md-10" data-animation-options="{
                    'delay': '.3s'
                }">
            <h2 class="mb-5 title title-center">Best Sellers</h2>
            <div class="owl-carousel owl-theme row owl-nav-full cols-2 cols-md-3 cols-lg-4" data-owl-options="{
                ...
                <div class="text-center product">
                    <figure class="product-media">
                        <a href="product.html">
                            <img src="{{ asset('user/images/demos/demo1/products/product1.jpg') }}"
                        ...
                        <div class="product-action-vertical">
                            <a href="demo1.html#" class="btn-product-icon btn-cart" data-toggle="modal"
                                data-target="#addCartModal" title="Add to cart"><i class="d-icon-bag"></i></a>
                            <a href="demo1.html#" class="btn-product-icon btn-wishlist" title="Add to wishlist"><i
                                    class="d-icon-heart"></i></a>
                        </div>
                        <div class="product-action">
                            <a href="demo1.html#" class="btn-product btn-quickview" title="Quick View">Quick
                                View</a>
                        </div>
                    </figure>
                ...
                <div class="text-center product">
                    <figure class="product-media">
                        <a href="product.html">
                            <img src="{{ asset('user/images/demos/demo1/products/product2.jpg') }}"
                                alt="Blue Pinafore Denim Dress" width="280" height="315"
                                style="background-color: #f2f3f5;" />
                        </a>
                        <div class="product-label-group">
                ...
                <div class="text-center product">
                    <figure class="product-media">
                        <a href="product.html">
                            <img src="{{ asset('user/images/demos/demo1/products/product3.jpg') }}"
                                alt="Blue Pinafore Denim Dress" width="280" height="315"
                                style="background-color: #f2f3f5;" />
                        </a>
                ...
                <div class="text-center product">
                    <figure class="product-media">
                        <a href="product.html">
                            <img src="{{ asset('user/images/demos/demo1/products/product4.jpg') }}"
                                alt="Blue Pinafore Denim Dress" width="280" height="315"
                                style="background-color: #f2f3f5;" />
                        </a>
                        <div class="product-label-group">
        ...
        <section class="mt-4 banner-group">
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="mb-4 col-lg-4 col-sm-6">
                        <div class="banner banner-3 overlay-zoom banner-fixed banner-radius content-middle appear-animate"
                            ...
                            <figure>
                                <img src="{{ asset('user/images/demos/demo1/banners/banner1.jpg') }}" alt="banner"
                                    width="380" height="207" style="background-color: #836648;" />
                            </figure>
                            <div class="banner-content">
                                <h3 class="mb-1 text-white banner-title">For Men's</h3>
                                <h4 class="text-white banner-subtitle text-uppercase font-weight-normal">
                                    Starting at $29
                                </h4>
                    ...
                    <div class="mb-4 col-lg-4 col-sm-6 order-lg-auto order-sm-last">
                        <div class="content-center banner banner-4 banner-fixed banner-radius overlay-effect2 content-middle appear-animate"
                            data-animation-options="{'name': 'fadeIn', 'duration': '1s', 'delay': '.2s'}">
                            <figure>
                                <img src="{{ asset('user/images/demos/demo1/banners/banner2.jpg') }}" alt="banner"
                                    width="350" height="177" style="background-color: #1e1e1e;" />
                            </figure>
                            <div class="text-left banner-content d-flex align-items-center w-100">
                                <div class="mb-4 mr-auto mb-md-0">
                                    <h4 class="text-white banner-subtitle">
                                        Up to 20% Off<br><span class="ls-l">Black Friday</span>
                                    </h4>
                                    <h3 class="mb-0 banner-title text-primary font-weight-bold lh-1">Sale</h3>
                                </div>
                                <a href="shop.html"
                                    class="text-white btn btn-primary btn-outline btn-rounded font-weight-bold">Shop
                                    Now<i class="d-icon-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="mb-4 col-lg-4 col-sm-6">
                        <div class="banner overlay-zoom banner-5 banner-fixed banner-radius content-middle appear-animate"
                            ...
                            <figure>
                                <img src="{{ asset('user/images/demos/demo1/banners/banner3.jpg') }}" alt="banner"
                                    width="380" height="207" style="background-color: #97928b;" />
                            </figure>
                            <div class="banner-content">
                                <h3 class="mb-1 text-white banner-title">Fashions</h3>
                                <h4 class="text-white banner-subtitle text-uppercase font-weight-normal">30% Off
                                </h4>
                                <hr class="banner-divider">
                                <a href="shop.html" class="btn btn-white btn-link btn-underline">Shop Now<i
                                        class="d-icon-arrow-right"></i></a>
        ...
        <section class="container pt-4 pb-2 mt-6 mb-10 product-wrapper mt-md-10 appear-animate" data-animation-options="{
                    'delay': '.6s'
                }">
            ...
            <div class="owl-carousel owl-theme row cols-2 cols-md-3 cols-lg-4 cols-xl-5" data-owl-options="{
                ...
                <div class="text-center product">
                    <figure class="product-media">
                        <a href="product.html">
                            <img src="{{ asset('user/images/demos/demo1/products/product5.jpg') }}"
                ...
                <div class="text-center product">
                    <figure class="product-media">
                        <a href="product.html">
                            <img src="{{ asset('user/images/demos/demo1/products/product6.jpg') }}"
                                alt="Blue Pinafore Denim Dress" width="220" height="245"
                                style="background-color: #f2f3f5;" />
                        </a>
                        <div class="product-label-group">
                ...
                <div class="text-center product">
                    <figure class="product-media">
                        <a href="product.html">
                            <img src="{{ asset('user/images/demos/demo1/products/product7.jpg') }}"
                                alt="Blue Pinafore Denim Dress" width="220" height="245"
                                style="background-color: #f2f3f5;" />
                        </a>
                        <div class="product-action-vertical">
                ...
                <div class="text-center product">
                    <figure class="product-media">
                        <a href="product.html">
                            <img src="{{ asset('user/images/demos/demo1/products/product8.jpg') }}"
                                alt="Blue Pinafore Denim Dress" width="220" height="245"
                                style="background-color: #f2f3f5;" />
                        </a>
                        <div class="product-label-group">
                ...
                <div class="text-center product">
                    <figure class="product-media">
                        <a href="product.html">
                            <img src="{{ asset('user/images/demos/demo1/products/product9.jpg') }}"
                                alt="Blue Pinafore Denim Dress" width="220" height="245"
                                style="background-color: #f2f3f5;" />
                        </a>
                        <div class="product-label-group">
        ...
        <section class="text-center banner banner-background parallax" data-option="{'offset': -60}"
            data-image-src="{{ asset('user/images/demos/demo1/parallax.jpg') }}" style="background-color: #2d2f33;">
            <div class="container">
                <div class="banner-content appear-animate"
                    data-animation-options="{'name': 'blurIn', 'duration': '1s', 'delay': '.2s'}">
                    <h4 class="text-white banner-subtitle font-weight-bold ls-l">
                        Extra<span class="ml-4 mr-2 d-inline-block label-star bg-dark text-primary">30%
                            Off</span>Online
                    </h4>
                    <h3 class="text-white banner-title font-weight-bold">Summer Season Sale</h3>
        ...
        <section class="mt-6 blog-post-wrapper mt-md-10 pt-7 appear-animate"
                ...
                <div class="owl-carousel owl-theme post-slider row cols-lg-3 cols-sm-2 cols-1" data-owl-options="{
                        ...
                        <article class="post post-frame overlay-zoom">
                            <figure class="post-media">
                                <a href="post-single.html">
                                    <img src="{{ asset('user/images/blog/frame/1.jpg') }}" alt="Blog post" width="340"
                    ...
                    <div class="mb-4 blog-post">
                        <article class="post post-frame overlay-zoom">
                            <figure class="post-media">
                                <a href="post-single.html">
                                    <img src="{{ asset('user/images/blog/frame/2.jpg') }}" alt="Blog post" width="340"
                    ...
                    <div class="mb-4 blog-post">
                        <article class="post post-frame overlay-zoom">
                            <figure class="post-media">
                                <a href="post-single.html">
                                    <img src="{{ asset('user/images/blog/frame/3.jpg') }}" alt="Blog post" width="340"
        ...
        <section class="pt-10 pb-6 mt-2 pb-md-10 appear-animate" data-animation-options="{
                    'delay': '.3s'
                }">
            ...
            <div class="container">
                <div class="owl-carousel owl-theme row brand-carousel cols-xl-6 cols-lg-5 cols-md-4 cols-sm-3 cols-2"
                    ...
                    <figure><img src="{{ asset('user/images/brands/1.png') }}" alt="brand" width="180" height="100" />
                    </figure>
                    <figure><img src="{{ asset('user/images/brands/2.png') }}" alt="brand" width="180" height="100" />
                    </figure>
                    <figure><img src="{{ asset('user/images/brands/3.png') }}" alt="brand" width="180" height="100" />
                    </figure>
                    <figure><img src="{{ asset('user/images/brands/4.png') }}" alt="brand" width="180" height="100" />
                    </figure>
                    <figure><img src="{{ asset('user/images/brands/5.png') }}" alt="brand" width="180" height="100" />
                    </figure>
                    <figure><img src="{{ asset('user/images/brands/6.png') }}" alt="brand" width="180" height="100" />
                    </figure>
                </div>
            </div>
        </section>

        <section class="pb-2 product-widget-wrapper pb-md-10 appear-animate">
            <div class="container">
                <div class="row">
                        ...
                        <div class="widget widget-products appear-animate" data-animation-options="{
                            ...
                            <div class="products-col">
                                <div class="product product-list-sm">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="{{ asset('user/images/demos/demo1/products/product10.jpg') }}"
                                ...
                                <div class="product product-list-sm">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="{{ asset('user/images/demos/demo1/products/product11.jpg') }}"
                                                alt="product" width="100" height="114"
                                                style="background-color: #f2f3f5;" />
                                        </a>
                                    </figure>
                                ...
                                <div class="product product-list-sm">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="{{ asset('user/images/demos/demo1/products/product12.jpg') }}"
                                                alt="product" width="100" height="114"
                                                style="background-color: #f2f3f5;" />
                                        </a>
                                    </figure>
                        ...
                        <div class="widget widget-products appear-animate" data-animation-options="{
                            ...
                            <div class="products-col">
                                <div class="product product-list-sm">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="{{ asset('user/images/demos/demo1/products/product13.jpg') }}"
                                                alt="product" width="100" height="114"
                                                style="background-color: #f2f3f5;" />
                                        </a>
                                    </figure>
                                ...
                                <div class="product product-list-sm">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="{{ asset('user/images/demos/demo1/products/product14.jpg') }}"
                                                alt="product" width="100" height="114"
                                                style="background-color: #f2f3f5;" />
                                        </a>
                                    </figure>
                                ...
                                <div class="product product-list-sm">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="{{ asset('user/images/demos/demo1/products/product15.jpg') }}"
                                                alt="product" width="100" height="114"
                                                style="background-color: #f2f3f5;" />
                                        </a>
                                    </figure>
                        ...
                        <div class="widget widget-products appear-animate" data-animation-options="{
                            ...
                            <div class="products-col">
                                <div class="product product-list-sm">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="{{ asset('user/images/demos/demo1/products/product16.jpg') }}"
                                                alt="product" width="100" height="114"
                                                style="background-color: #f2f3f5;" />
                                        </a>
                                    </figure>
                                ...
                                <div class="product product-list-sm">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="{{ asset('user/images/demos/demo1/products/product17.jpg') }}"
                                                alt="product" width="100" height="114"
                                                style="background-color: #f2f3f5;" />
                                        </a>
                                    </figure>
                                ...
                                <div class="product product-list-sm">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="{{ asset('user/images/demos/demo1/products/product18.jpg') }}"
                                                alt="product" width="100" height="114"
                                                style="background-color: #f2f3f5;" />
                                        </a>
                                    </figure>
                        ...
                        <div class="widget widget-products appear-animate" data-animation-options="{
                            ...
                            <div class="products-col">
                                <div class="product product-list-sm">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="{{ asset('user/images/demos/demo1/products/product19.jpg') }}"
                                                alt="product" width="100" height="114"
                                                style="background-color: #f2f3f5;" />
                                        </a>
                                    </figure>
                                ...
                                <div class="product product-list-sm">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="{{ asset('user/images/demos/demo1/products/product20.jpg') }}"
                                                alt="product" width="100" height="114"
                                                style="background-color: #f2f3f5;" />
                                        </a>
                                    </figure>
                                ...
                                <div class="product product-list-sm">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="{{ asset('user/images/demos/demo1/products/product21.jpg') }}"
                                                alt="product" width="100" height="114"
                                                style="background-color: #f2f3f5;" />
                                        </a>
                                    </figure>
