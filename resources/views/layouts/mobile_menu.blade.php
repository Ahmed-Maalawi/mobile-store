<div class="mobile-menu-wrapper">
    ...
    <!-- End of Overlay -->
    <a class="mobile-menu-close" href="demo1.html#"><i class="d-icon-times"></i></a>
    <!-- End of CloseButton -->
    <div class="mobile-menu-container scrollable">
        ...
        <ul class="mobile-menu mmenu-anim">
            ...
            <li>
                ...
                <ul>
                    <li>
                        <a href="demo1.html#">Product Pages</a>
                        <ul>
                    ...
                    <li>
                        <a href="demo1.html#">Product Layouts</a>
                        <ul>
                    ...
                    <li>
                        <a href="demo1.html#">Product Features</a>
                        <ul>
            ...
            <li>
                ...
                <ul>
                    <li>
                        <a href="demo1.html#">Elements 1</a>
                        <ul>
                    ...
                    <li>
                        <a href="demo1.html#">Elements 2</a>
                        <ul>
                    ...
                    <li>
                        <a href="demo1.html#">Elements 3</a>
                        <ul>
                    ...
                    <li>
                        <a href="demo1.html#">Elements 4</a>
                        <ul>
