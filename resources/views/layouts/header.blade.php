<header class="header">
    <div class="header-top">
        <div class="container">
            ...
            <div class="header-right">
                <div class="dropdown">
                    <a href="demo1.html#currency">USD</a>
                    <ul class="dropdown-box">
                        <li><a href="demo1.html#USD">USD</a></li>
                        <li><a href="demo1.html#EUR">EUR</a></li>
                    </ul>
                </div>
                <!-- End DropDown Menu -->
                <div class="ml-5 dropdown">
                    <a href="demo1.html#language">ENG</a>
                    <ul class="dropdown-box">
                        <li>
                            <a href="demo1.html#USD">ENG</a>
                        </li>
                        <li>
                            <a href="demo1.html#EUR">FRH</a>
                        </li>
                    </ul>
                </div>
                <!-- End DropDown Menu -->
                ...
                <a href="demo1.html#" class="help d-lg-show"><i class="d-icon-info"></i> Need Help</a>
                <a href="demo1.html#signin" class="login-toggle link-to-tab d-md-show"><i class="d-icon-user"></i>Sign
                    in</a>
                <span class="delimiter">/</span>
                <a href="demo1.html#register" class="ml-0 register-toggle link-to-tab d-md-show">Register</a>
                        ...
                        <div class="login-popup">
                            <div class="form-box">
                                <div class="tab tab-nav-simple tab-nav-boxed form-tab">
                                    <ul class="mb-5 nav nav-tabs nav-fill align-items-center border-no justify-content-center"
                                        role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active border-no lh-1 ls-normal"
                                                href="demo1.html#signin">Login</a>
                                        </li>
                                        <li class="delimiter">or</li>
                                        <li class="nav-item">
                                            <a class="nav-link border-no lh-1 ls-normal"
                                                href="demo1.html#register">Register</a>
                                        </li>
                                    </ul>
                                        ...
                                        <div class="tab-pane active" id="signin">
                                            <form action="demo1.html#">
                                                ...
                                                <div class="form-footer">
                                                    ...
                                                    <a href="demo1.html#" class="lost-link">Lost your
                                                        password?</a>
                                                </div>
                                                <button class="btn btn-dark btn-block btn-rounded"
                                                    type="submit">Login</button>
                                            </form>
                                            <div class="text-center form-choice">
                                                <label class="ls-m">or Login With</label>
                                                <div class="social-links">
                                                    <a href="demo1.html#" title="social-link"
    ...
    <div class="header-middle sticky-header fix-top sticky-content">
        <div class="container">
            <div class="header-left">
                <a href="demo1.html#" class="mobile-menu-toggle">
                    <i class="d-icon-bars2"></i>
                </a>
                <a href="demo1.html" class="logo">
                    <img src="{{ asset('user/images/logo.png') }}" alt="logo" width="153" height="44" />
                </a>
                <!-- End Logo -->
            ...
            <div class="header-right">
                ...
                <div class="dropdown wishlist wishlist-dropdown off-canvas">
                    ...
                    <div class="dropdown-box scrollable">
                        <div class="canvas-header">
                            ...
                            <a href="demo1.html#" class="btn btn-dark btn-link btn-icon-right btn-close">close<i
                        ...
                        <div class="products scrollable">
                            <div class="product product-wishlist">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{ asset('user/images/wishlist/product-1.jpg') }}" width="100"
                            ...
                            <div class="product product-wishlist">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{ asset('user/images/wishlist/product-2.jpg') }}" width="100"
                                            height="100" alt="product" />
                                    </a>
                                    <button class="btn btn-link btn-close">
                                        <i class="fas fa-times"></i><span class="sr-only">Close</span>
                            ...
                            <div class="product product-wishlist">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{ asset('user/images/wishlist/product-3.jpg') }}" width="100"
                                            height="100" alt="product" />
                                    </a>
                                    <button class="btn btn-link btn-close">
                                        <i class="fas fa-times"></i><span class="sr-only">Close</span>
                        ...
                        <a href="wishlist.html" class="mt-4 btn btn-dark wishlist-btn"><span>Go To
                                Wishlist</span></a>
                        <!-- End of Products  -->
                    </div>
                    <!-- End Dropdown Box -->
                ...
                <span class="divider"></span>
                <div class="mr-0 dropdown cart-dropdown type2 off-canvas mr-lg-2">
                    <a href="demo1.html#" class="cart-toggle label-block link">
                    ...
                    <div class="dropdown-box">
                        ...
                        <div class="products scrollable">
                            <div class="product product-cart">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{ asset('user/images/cart/product-1.jpg') }}" alt="product"
                                            width="80" height="88" />
                                    </a>
                                    <button class="btn btn-link btn-close">
                                        <i class="fas fa-times"></i><span class="sr-only">Close</span>
                            ...
                            <div class="product product-cart">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{ asset('user/images/cart/product-2.jpg') }}" alt="product"
                                            width="80" height="88" />
                                    </a>
                                    <button class="btn btn-link btn-close">
                                        <i class="fas fa-times"></i><span class="sr-only">Close</span>
    ...
    <div class="header-bottom d-lg-show">
        <div class="container">
                            ...
                            <div class="megamenu">
                                <div class="row">
                                    ...
                                    <div
                                        ...
                                        <figure>
                                            <img src="{{ asset('user/images/menu/banner-1.jpg') }}" alt="Menu banner"
                            ...
                            <div class="megamenu">
                                <div class="row">
                                    ...
                                    <div class="col-6 col-sm-4 col-md-3 menu-banner menu-banner2 banner banner-fixed">
                                        <figure>
                                            <img src="{{ asset('user/images/menu/banner-2.jpg') }}" alt="Menu banner"
                                                width="221" height="330" />
                                        </figure>
                                        <div class="text-center banner-content x-50">
                                            <h3 class="text-white banner-title text-uppercase">Sunglasses</h3>
                                            <h4 class="mb-0 text-white banner-subtitle font-weight-bold">$23.00
                                                -
                                                $120.00</h4>
                                        </div>
                                    </div>
            ...
            <div class="header-right">
                <a href="demo1.html#"><i class="d-icon-card"></i>Special Offers</a>
